Shader "Sonar/SonarObject"
{
    ...
    SubShader
    {
        ...
        // Le bruit deforme la forme 3D originale :
        // position finale = position originale + (bruit * normale)
        float3 NoiseDisplace(float3 posWS, float3 normWS)
        {
            ...
            // Ajoute le deplacement a la position originale du sommet
            return posWS + normWS * d;
        }
